...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param name_one the first half of this Silly instance's name.
     * @param name_two the second half of this Silly instance's name.
     */
    public Silly(String name_one, String name_two) {
        this.name = name_one + name_two;
    }
